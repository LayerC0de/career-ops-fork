...
## [1.28.0](https://github.com/LayerC0de/career-ops-fork/compare/career-ops-v1.27.0...career-ops-v1.28.0) (2026-08-18)


### Features

* add company:funded — review-first funded-company discovery from public RSS sources ([#2117](https://github.com/LayerC0de/career-ops-fork/issues/2117)) ([7ab92ab](https://github.com/LayerC0de/career-ops-fork/commit/7ab92abb139ccd0e8712d62b2fff4211c551fd33))
* **application-answers:** parse a rendered section back into a snapshot ([3313515](https://github.com/LayerC0de/career-ops-fork/commit/331351566605ba68c8115c2a99a00290edcb4a68))
* **batch:** add batch-tailor.mjs for bulk CV tailoring of high-scoring roles ([#1882](https://github.com/LayerC0de/career-ops-fork/issues/1882)) ([d5384ef](https://github.com/LayerC0de/career-ops-fork/commit/d5384efd43d2d73c88e4267ab2f5ec7099e95df1)), closes [#1836](https://github.com/LayerC0de/career-ops-fork/issues/1836)
* **cli:** add --help / -h usage block to stats.mjs ([#2556](https://github.com/LayerC0de/career-ops-fork/issues/2556)) ([3d8b53d](https://github.com/LayerC0de/career-ops-fork/commit/3d8b53dcf41917d889deff8435e869a5a53c6550))
* **cli:** add Cursor as a supported CLI host ([#2115](https://github.com/LayerC0de/career-ops-fork/issues/2115)) ([119d75c](https://github.com/LayerC0de/career-ops-fork/commit/119d75ceec5b5182b9380f0c9b48919c73245206))
* **cli:** shared flag-validation helper, migrate 3 fixed scripts, fix scan.mjs ([#2778](https://github.com/LayerC0de/career-ops-fork/issues/2778)) ([f05fc0f](https://github.com/LayerC0de/career-ops-fork/commit/f05fc0fe8013a28468f0cab69adb281a36c8d37b)), closes [#2775](https://github.com/LayerC0de/career-ops-fork/issues/2775)
...
* **contacts:** company-history.mjs, employer silence and repost facts ([#1712](https://github.com/LayerC0de/career-ops-fork/issues/1712)) ([af21577](https://github.com/LayerC0de/career-ops-fork/commit/af2157747b730284e97c99936f2d15d3fa2977f9)), closes [#1711](https://github.com/LayerC0de/career-ops-fork/issues/1711)
* **contacts:** job-search phonebook with vCard export ([#1719](https://github.com/LayerC0de/career-ops-fork/issues/1719)) ([8bba0ee](https://github.com/LayerC0de/career-ops-fork/commit/8bba0ee59b2cb584ab06d9379a6a02e537841508))
* **cover:** optional letter.signature sign-off block ([#2513](https://github.com/LayerC0de/career-ops-fork/issues/2513)) ([449c1df](https://github.com/LayerC0de/career-ops-fork/commit/449c1df4a235205bb1907c7c572d2fa09a9321b9)), closes [#2510](https://github.com/LayerC0de/career-ops-fork/issues/2510)
* **cv:** add optional Awards / Honors section to HTML + LaTeX CV templates ([#2220](https://github.com/LayerC0de/career-ops-fork/issues/2220)) ([59df4bb](https://github.com/LayerC0de/career-ops-fork/commit/59df4bb11a278bfacd23dcdec15e4b9cfc401782))
* **cv:** block unsupported employer, title, and tool claims in cover letters ([10a2e75](https://github.com/LayerC0de/career-ops-fork/commit/10a2e75526feb0db9162994b19ea6ebaba8b587e))
* **cv:** recommend CV reuse for similar JDs — deterministic jd-similarity helper ([07a7d9f](https://github.com/LayerC0de/career-ops-fork/commit/07a7d9f7edae960b274d3c9f9ca2e15af4d86f62))
* **cv:** strip the Core Competencies section when it has no entries ([#2512](https://github.com/LayerC0de/career-ops-fork/issues/2512)) ([f1b2bc6](https://github.com/LayerC0de/career-ops-fork/commit/f1b2bc6eb7f553c60d60d43b672c7004a4a6b0ef)), closes [#2509](https://github.com/LayerC0de/career-ops-fork/issues/2509)
* **cv:** support declarative section HTML partials from disk ([#2184](https://github.com/LayerC0de/career-ops-fork/issues/2184)) ([aefed14](https://github.com/LayerC0de/career-ops-fork/commit/aefed14a625bb078218fb197a7e2430d826beca7)), closes [#2183](https://github.com/LayerC0de/career-ops-fork/issues/2183)
* **dashboard:** add a POSTED column showing requisition age ([#2692](https://github.com/LayerC0de/career-ops-fork/issues/2692)) ([a229727](https://github.com/LayerC0de/career-ops-fork/commit/a22972772f2bba7334334550b5eca630d3f26d51))
* **dashboard:** add a RESPONDED filter tab to the pipeline screen ([#2000](https://github.com/LayerC0de/career-ops-fork/issues/2000)) ([eff33e6](https://github.com/LayerC0de/career-ops-fork/commit/eff33e66367279803a0c737444481e283e6d6edb)), closes [#1999](https://github.com/LayerC0de/career-ops-fork/issues/1999)
* **dashboard:** add Stats analytics view with score quality & seniority mix charts ([#2960](https://github.com/LayerC0de/career-ops-fork/issues/2960)) ([9f0c3c3](https://github.com/LayerC0de/career-ops-fork/commit/9f0c3c39f203e29fb742749aef642e122ff8f822))
* **dashboard:** build the pay-span regex from an explicit currency list ([#2201](https://github.com/LayerC0de/career-ops-fork/issues/2201)) ([37f20ab](https://github.com/LayerC0de/career-ops-fork/commit/37f20ab86dac507a8885068c89746e27f8c6892f))
* **discover-ats:** probe the long-tail ATS vendors, not just the big three ([2d6f188](https://github.com/LayerC0de/career-ops-fork/commit/2d6f188c3a7ba4ac19c08fe98aa7bc558803018b))
* **doctor:** CLI-aware Playwright MCP detection + OpenCode config support ([#2247](https://github.com/LayerC0de/career-ops-fork/issues/2247)) ([960d00b](https://github.com/LayerC0de/career-ops-fork/commit/960d00b3a45a8213db9e7279727d9422887329a6))
* **doctor:** emit the Gemini Node 20+ verdict instead of leaving it in prose ([#3032](https://github.com/LayerC0de/career-ops-fork/issues/3032)) ([e98bc6b](https://github.com/LayerC0de/career-ops-fork/commit/e98bc6ba9bb29ac625256b38ee548bbd588e0985))
* **doctor:** warn when an API key is overriding the Claude subscription ([ccb7b0d](https://github.com/LayerC0de/career-ops-fork/commit/ccb7b0d86a8de28c5858c9276529b56a448cf7b7))
* **eval:** token-budget-aware context compression for the Gemini and OpenAI evaluators ([#2060](https://github.com/LayerC0de/career-ops-fork/issues/2060)) ([4a9281b](https://github.com/LayerC0de/career-ops-fork/commit/4a9281b5c75d3ed5fa5ce39c2c13e3f38aaec00b)), closes [#2077](https://github.com/LayerC0de/career-ops-fork/issues/2077)
* **followup:** rejection-latency signal, courtesy-threshold only ([#2014](https://github.com/LayerC0de/career-ops-fork/issues/2014)) ([70e6152](https://github.com/LayerC0de/career-ops-fork/commit/70e615283794e450a0105ddeaf14d6ff844ecdec))
* **followups:** export withFollowupsLock so other writers can share the lock ([fba3bb2](https://github.com/LayerC0de/career-ops-fork/commit/fba3bb2029af81c0193adf7b6cb0adcc0cec840b))
* **i18n:** add Dutch (nl) modes ([#1970](https://github.com/LayerC0de/career-ops-fork/issues/1970)) ([0099c42](https://github.com/LayerC0de/career-ops-fork/commit/0099c420c6efc39b2a4b687c62ff55a94b807b73))
* **i18n:** add Italian translations for interview modes ([#2335](https://github.com/LayerC0de/career-ops-fork/issues/2335)) ([8127c93](https://github.com/LayerC0de/career-ops-fork/commit/8127c932f0c14200e7e519495ce52d033ab3a3f6))
* **intake:** read documents/ locally to propose source-annotated profile additions ([87abc32](https://github.com/LayerC0de/career-ops-fork/commit/87abc322ab5686cd6c4fd7d91aa3154258d77dcd))
* **interview-prep:** detect call platform (phone/Zoom/Teams/Meet) from invite text ([9acfec1](https://github.com/LayerC0de/career-ops-fork/commit/9acfec10cac786013826a93d668e732b6595e7d3))
* **interview-redflag:** protected-grounds question detection with jurisdiction table ([#2030](https://github.com/LayerC0de/career-ops-fork/issues/2030)) ([6b25cdd](https://github.com/LayerC0de/career-ops-fork/commit/6b25cddfbddef406b31b9d89d9527b9d2434483c))
* **interview/debrief:** correct contradicted facts in the prep file in place ([e8e912b](https://github.com/LayerC0de/career-ops-fork/commit/e8e912b777bad303f430ffa9e1eb03950157c15b))
* **interview/plan:** wire in interview-prep's sourced-question research before Block 4 ([3ceb404](https://github.com/LayerC0de/career-ops-fork/commit/3ceb404d5ff15edacab2755325b9571f96f045f6))
* **interview:** debrief directly from an existing transcript ([#2122](https://github.com/LayerC0de/career-ops-fork/issues/2122)) ([5cb7f0a](https://github.com/LayerC0de/career-ops-fork/commit/5cb7f0af9c6709505c1b85c0641f46825bc8d02b))
* **invite-match:** distinguish AI-interviewer platforms from human calls ([#2676](https://github.com/LayerC0de/career-ops-fork/issues/2676)) ([7fa3b1d](https://github.com/LayerC0de/career-ops-fork/commit/7fa3b1d2f362f65a3d346a09fd7ba609fffe3eb7)), closes [#2673](https://github.com/LayerC0de/career-ops-fork/issues/2673)
* **invite-match:** recognize rejection emails, not just interview invites ([#2100](https://github.com/LayerC0de/career-ops-fork/issues/2100)) ([9bbdd9b](https://github.com/LayerC0de/career-ops-fork/commit/9bbdd9b495974ce3be7d5713f8d0614a1957aec3))
* **latex-tex:** support resumeItemWithoutTitle bullets and resumeSubItem skills ([#2120](https://github.com/LayerC0de/career-ops-fork/issues/2120)) ([0d4fa4d](https://github.com/LayerC0de/career-ops-fork/commit/0d4fa4d1b70f2c3bf7a8cd2907a2eb9fc64faed0))
* **ledger:** set-status transition log + mode wiring ([#1695](https://github.com/LayerC0de/career-ops-fork/issues/1695)) ([2af59e6](https://github.com/LayerC0de/career-ops-fork/commit/2af59e6e2f3b734fd7487b8fca62790671c9bb5a))
* **negotiation:** ROI-based salary-negotiation talking points from verified achievements ([#2950](https://github.com/LayerC0de/career-ops-fork/issues/2950)) ([03b440f](https://github.com/LayerC0de/career-ops-fork/commit/03b440f15104f1d7545fb8a0b316038f563ba2f0))
...
* **oferta:** flag explicit no-sponsorship as a hard blocker ([#2017](https://github.com/LayerC0de/career-ops-fork/issues/2017)) ([933aa01](https://github.com/LayerC0de/career-ops-fork/commit/933aa019199fd96f7c62497d32dab1c08d4b7720)), closes [#2016](https://github.com/LayerC0de/career-ops-fork/issues/2016)
* **oferta:** minimum-wage lawyer question, arithmetic-only ([#2027](https://github.com/LayerC0de/career-ops-fork/issues/2027)) ([0118404](https://github.com/LayerC0de/career-ops-fork/commit/0118404946260fa68b449399042bf0eb351d4aaf))
* **oferta:** pay-transparency range-width check, self-computed only ([#2021](https://github.com/LayerC0de/career-ops-fork/issues/2021)) ([9482765](https://github.com/LayerC0de/career-ops-fork/commit/948276555b0e0449d4415ad39b61f8016bbf90b8))
* **offer-prep:** jurisdiction-aware restrictive-covenant notes ([#2029](https://github.com/LayerC0de/career-ops-fork/issues/2029)) ([6eb7778](https://github.com/LayerC0de/career-ops-fork/commit/6eb7778b68dad59990694f32e86c9527fd222343))
* **offer-prep:** sub-statutory terms route to lawyer, no floors table ([#2042](https://github.com/LayerC0de/career-ops-fork/issues/2042)) ([51ae334](https://github.com/LayerC0de/career-ops-fork/commit/51ae334b2faf2ae9e1d256139d83a0f7f144829c))
* **outcome:** outcome recording and application archiving, phase 1 ([#2248](https://github.com/LayerC0de/career-ops-fork/issues/2248)) ([6d60073](https://github.com/LayerC0de/career-ops-fork/commit/6d600736ca316182283d3c669d9b4c77f91d0964))
* **pdf:** batch render path reusing one Chromium across N CVs ([#2747](https://github.com/LayerC0de/career-ops-fork/issues/2747)) ([7bb5c32](https://github.com/LayerC0de/career-ops-fork/commit/7bb5c3279baad31a4215988576d0a6e99350e774))
* **pdf:** dynamic CSS theming from a profile.yml style block ([#1862](https://github.com/LayerC0de/career-ops-fork/issues/1862)) ([6271e6d](https://github.com/LayerC0de/career-ops-fork/commit/6271e6d9cd6ad9f2a98fb934e02f8bcb6e632886)), closes [#1837](https://github.com/LayerC0de/career-ops-fork/issues/1837)
* **pdf:** opt-in hiring-manager audit pass — adversarial, research-grounded CV review ([#2239](https://github.com/LayerC0de/career-ops-fork/issues/2239)) ([3024413](https://github.com/LayerC0de/career-ops-fork/commit/3024413f54e683728b581ec1f251fc89c0b60d5a))
* **portals:** standalone fix-slugs.mjs — auto-write ATS slug fixes to portals.yml ([7ab1a1d](https://github.com/LayerC0de/career-ops-fork/commit/7ab1a1d6e30ccb02a53adde031e6bd6ae648d4c4))
* **providers:** a16z speedrun talent network board-wide feed ([#2231](https://github.com/LayerC0de/career-ops-fork/issues/2231)) ([1b785a9](https://github.com/LayerC0de/career-ops-fork/commit/1b785a93e2082830ea1d73eb1328cb05c93644bd))
* **providers:** add Flowxtra board-wide job provider ([c9671e0](https://github.com/LayerC0de/career-ops-fork/commit/c9671e08f92ebc7d01aba0b41d084dd5322afd18))
* **providers:** add iCIMS to the reverse-ATS full sweep ([#2141](https://github.com/LayerC0de/career-ops-fork/issues/2141)) ([b9cd65e](https://github.com/LayerC0de/career-ops-fork/commit/b9cd65e8ddba9448c9590c25f45288cf61c1c1c7)), closes [#2137](https://github.com/LayerC0de/career-ops-fork/issues/2137)
* **providers:** add join.com SSR __NEXT_DATA__ parser ([#2527](https://github.com/LayerC0de/career-ops-fork/issues/2527)) ([2b64bf5](https://github.com/LayerC0de/career-ops-fork/commit/2b64bf55f3821fe86990e57362f1740ccd1f9d77))
* **providers:** add remotli — Swiss remote job board ([#2464](https://github.com/LayerC0de/career-ops-fork/issues/2464)) ([dca9418](https://github.com/LayerC0de/career-ops-fork/commit/dca94180f9666dfc93b8dff4ff41bad97e58588d))
...
* **providers:** add yourator job board provider ([c664576](https://github.com/LayerC0de/career-ops-fork/commit/c664576dec4185e140518d9bc1fd2beaf299f901))
* **providers:** cryptocurrencyjobs — Web3 job board via public RSS, zero-auth ([3310855](https://github.com/LayerC0de/career-ops-fork/commit/331085540ad2330c158619f1e7e3bf4dc40db21e))
* **providers:** Eightfold AI talent-acquisition boards ([#2684](https://github.com/LayerC0de/career-ops-fork/issues/2684)) ([e991d58](https://github.com/LayerC0de/career-ops-fork/commit/e991d5853fdf708639721124c9bac17ff291f2b0))
* **providers:** extend getro with auto-resolve, salary, retry and remote-detect ([#2640](https://github.com/LayerC0de/career-ops-fork/issues/2640)) ([85c0928](https://github.com/LayerC0de/career-ops-fork/commit/85c0928871be11df54c4769a73a5069bbef6b152)), closes [#2602](https://github.com/LayerC0de/career-ops-fork/issues/2602)
* **providers:** getManfred board-wide feed (Spanish/EU tech, salaries published) ([9474ff1](https://github.com/LayerC0de/career-ops-fork/commit/9474ff12b56b87700cad42dc1ace545ac1f9b3e2))
* **providers:** senjob — the scanner's first African source, Senegal ([#2962](https://github.com/LayerC0de/career-ops-fork/issues/2962)) ([db9bd6a](https://github.com/LayerC0de/career-ops-fork/commit/db9bd6aefb45c8297184eaa38cd1c1f006cd7ed8))
* **radancy:** support legacy TalentBrew markup and the JSON results fragment ([a3e6df9](https://github.com/LayerC0de/career-ops-fork/commit/a3e6df971c563405c67deaf63bfcc27d8cb44bbb))
* **rank:** opt-in LLM relevance re-ranker for pipeline.md ([#2579](https://github.com/LayerC0de/career-ops-fork/issues/2579)) ([03fc92b](https://github.com/LayerC0de/career-ops-fork/commit/03fc92bb04e1fc8821ff4ec71b26bcc6f0da1182))
* **reports:** add reports_to to the Machine Summary schema ([8cf3dac](https://github.com/LayerC0de/career-ops-fork/commit/8cf3dac5a0f7df0e815d9b57d7337ba7ae3eeea9))
* **reposts:** add --help usage block to detect-reposts ([6ec8e15](https://github.com/LayerC0de/career-ops-fork/commit/6ec8e157639a6f2b53e3c3ad9a051ed3c69ea5f8))
* **scan-history:** additive normalized-company column for reliable repost keying ([#2243](https://github.com/LayerC0de/career-ops-fork/issues/2243)) ([a4575a6](https://github.com/LayerC0de/career-ops-fork/commit/a4575a64a550608ecca3386851f6ad76aa592205))
* **scan:** add --since, a relative posted-date bound that also stops paging early ([1d9ff63](https://github.com/LayerC0de/career-ops-fork/commit/1d9ff6343239dfb2dae9d91e091685e6c2641c9d))
* **scan:** add getro, consider and joinup zero-auth providers ([#825](https://github.com/LayerC0de/career-ops-fork/issues/825)) ([c0a259a](https://github.com/LayerC0de/career-ops-fork/commit/c0a259a900eab439d95d9787eb093b445425d6bb))
* **scan:** add Playwright scanner for Interamt.de ([2a132d0](https://github.com/LayerC0de/career-ops-fork/commit/2a132d0348bff2381f75d0aa13a3173391968bfb))
* **scan:** AND-groups in title_filter.positive ([#2552](https://github.com/LayerC0de/career-ops-fork/issues/2552)) ([5483083](https://github.com/LayerC0de/career-ops-fork/commit/548308354899de91be27fa2df8fefd176ef88e01))
* **scan:** country-eligibility filter for remote postings ([#2095](https://github.com/LayerC0de/career-ops-fork/issues/2095)) ([79ba55d](https://github.com/LayerC0de/career-ops-fork/commit/79ba55d7f66863eb6e7e8ce213fb8dd98b30de49)), closes [#2093](https://github.com/LayerC0de/career-ops-fork/issues/2093)
* **scan:** discover-ats.mjs — resolve a company list to scannable ATS boards ([#1865](https://github.com/LayerC0de/career-ops-fork/issues/1865)) ([50874d1](https://github.com/LayerC0de/career-ops-fork/commit/50874d109ebc7adb35e7e67100687e4d96f42cce)), closes [#1864](https://github.com/LayerC0de/career-ops-fork/issues/1864)
* **scan:** make the pipeline and scan-history paths env-overridable ([#2568](https://github.com/LayerC0de/career-ops-fork/issues/2568)) ([402e798](https://github.com/LayerC0de/career-ops-fork/commit/402e7988d33962ae3e9eb7f76afa2e55ddc37f1c)), closes [#2271](https://github.com/LayerC0de/career-ops-fork/issues/2271)
* **scan:** negative-cache resolver refusals and stop the sweep on a resolver outage ([#2266](https://github.com/LayerC0de/career-ops-fork/issues/2266)) ([ebaed15](https://github.com/LayerC0de/career-ops-fork/commit/ebaed15abd5d445bb86ae6e8988abc816cc9b9b2))
* **scan:** pace DNS lookups so a full sweep can't trip a resolver's rate limit ([e03719b](https://github.com/LayerC0de/career-ops-fork/commit/e03719b417b5e5f4de4153e4927a90fbba5ea5a0))
* **scan:** record failed runs in scan-runs.tsv so trends exclude survivorship bias ([713a6b0](https://github.com/LayerC0de/career-ops-fork/commit/713a6b0c928be43ed2fc1201d3cf140457f8c6cf))
* **skill-extract:** recognize certifications, not just engineering tools ([#2603](https://github.com/LayerC0de/career-ops-fork/issues/2603)) ([4c6a1d2](https://github.com/LayerC0de/career-ops-fork/commit/4c6a1d254d9933c0fd0ff3c200b900f7c928547a))
* **skills:** extract the shared skill tokenizer into skill-extract.mjs ([#2003](https://github.com/LayerC0de/career-ops-fork/issues/2003)) ([c110825](https://github.com/LayerC0de/career-ops-fork/commit/c110825a539d29c8dde25ad0d036babcaffefb18))
* **stats:** wire followup-cadence's cold classification into activeApps ([52a2be8](https://github.com/LayerC0de/career-ops-fork/commit/52a2be88a567133276cd917323646c2228860579))
* **templates:** five named CV templates + a contract test for template variants ([#2954](https://github.com/LayerC0de/career-ops-fork/issues/2954)) ([314cbb5](https://github.com/LayerC0de/career-ops-fork/commit/314cbb5f00a5e5e8a5bbcf875948e9f4c9cb8915))
* **test:** dynamic upgrade PR gate — old install applies the commit under test ([#2358](https://github.com/LayerC0de/career-ops-fork/issues/2358)) ([aa57dcb](https://github.com/LayerC0de/career-ops-fork/commit/aa57dcb1803a8a8ae41f60f587308738f9626e3a))
* **test:** seed-fixture.mjs + era-appropriate install fixtures ([#2032](https://github.com/LayerC0de/career-ops-fork/issues/2032)) ([0c5d146](https://github.com/LayerC0de/career-ops-fork/commit/0c5d1469e865c0a1720b8e0002469e8a05f874c2))
* **tracker-sync-check:** flag applications.md rows that active-interviews.md has already moved past ([a1304a4](https://github.com/LayerC0de/career-ops-fork/commit/a1304a42181ed6a735b2bfcc19db938134061ed3))
* **triage:** standalone two-pass triage mode to cut evaluation tokens ([#1550](https://github.com/LayerC0de/career-ops-fork/issues/1550)) ([7f281d8](https://github.com/LayerC0de/career-ops-fork/commit/7f281d829676fadadd7a934376469fea26394f16))
* **update:** declare fork-local paths outside the system layer ([#2793](https://github.com/LayerC0de/career-ops-fork/issues/2793)) ([b082ec6](https://github.com/LayerC0de/career-ops-fork/commit/b082ec6a9c4765cebf51d1038ab9a2195caeb434))
* **update:** restore locally deleted system files instead of preserving the deletion ([#2448](https://github.com/LayerC0de/career-ops-fork/issues/2448)) ([bfcaaba](https://github.com/LayerC0de/career-ops-fork/commit/bfcaaba7ba5662cd815b4e573757e9920515e7af))
* **upskill:** learning plan on the aggregate gap heatmap ([#2217](https://github.com/LayerC0de/career-ops-fork/issues/2217)) ([f20d3e2](https://github.com/LayerC0de/career-ops-fork/commit/f20d3e27080217eb9a48dccdc79843d27da319fb)), closes [#1740](https://github.com/LayerC0de/career-ops-fork/issues/1740)
* versioned application CV artifact schema — bundles with flat-path coexistence ([1c7a7cb](https://github.com/LayerC0de/career-ops-fork/commit/1c7a7cbd3dd3a8cbd1e51f38abadfa123a45d7cd))
...
* **weekly-digest:** weekly interview digest aggregator ([#2130](https://github.com/LayerC0de/career-ops-fork/issues/2130)) ([37a5184](https://github.com/LayerC0de/career-ops-fork/commit/37a5184ba0bbcb590f5e17cfbf6a718db1527460))


### Bug Fixes

* **a16z-speedrun:** retry a transient page failure instead of aborting the whole board ([#2506](https://github.com/LayerC0de/career-ops-fork/issues/2506)) ([50ce177](https://github.com/LayerC0de/career-ops-fork/commit/50ce17718c3ca5fc36103d41b48b30027eac44d8))
* **add-entry:** key non-Latin headings and dedup keys faithfully ([#2850](https://github.com/LayerC0de/career-ops-fork/issues/2850)) ([27757e4](https://github.com/LayerC0de/career-ops-fork/commit/27757e4896e5213a69440ecf17e54e0a413cbe06))
* **add-entry:** reject mistyped flags instead of reading them as data ([f4c4fda](https://github.com/LayerC0de/career-ops-fork/commit/f4c4fda5b3b31ee78070ea3884d1bc4b0570fc7f))
* **agent-inbox:** give concurrent add() a burst-sized lock timeout ([#2825](https://github.com/LayerC0de/career-ops-fork/issues/2825)) ([513f07a](https://github.com/LayerC0de/career-ops-fork/commit/513f07a2582c7e6dc03644733e796f4aec749f21)), closes [#2824](https://github.com/LayerC0de/career-ops-fork/issues/2824)
* **agent-inbox:** serialize concurrent adds through the shared lock ([#2777](https://github.com/LayerC0de/career-ops-fork/issues/2777)) ([a7f65b6](https://github.com/LayerC0de/career-ops-fork/commit/a7f65b6a63e90560270c4afb213204bab57981ab))
* **agent-inbox:** stop dropping requests queued during an add ([#2614](https://github.com/LayerC0de/career-ops-fork/issues/2614)) ([ad382c0](https://github.com/LayerC0de/career-ops-fork/commit/ad382c0b7f1fc2d4fc9a32094a49931c114e2a4b))
* **agentic-jobs:** replace the broken HTML scraper with the documented REST API ([#2167](https://github.com/LayerC0de/career-ops-fork/issues/2167)) ([3aee274](https://github.com/LayerC0de/career-ops-fork/commit/3aee27462bf9000df9b366ad493ae579d962804f)), closes [#2143](https://github.com/LayerC0de/career-ops-fork/issues/2143)
* **analyze-patterns:** use symbol-safe lookarounds so C++, C# and .NET stop vanishing from tech gaps ([#2227](https://github.com/LayerC0de/career-ops-fork/issues/2227)) ([85cb018](https://github.com/LayerC0de/career-ops-fork/commit/85cb018a4c5ec06a806384e965b77e2374bace6b))
* **arbeitsagentur:** move to the v6 Jobsuche API ([#2494](https://github.com/LayerC0de/career-ops-fork/issues/2494)) ([a713ed5](https://github.com/LayerC0de/career-ops-fork/commit/a713ed5de2850d6e3f5acb5677f198a31483271a))
* **archive:** key JD captures to report numbers so they resolve after capture day ([#2701](https://github.com/LayerC0de/career-ops-fork/issues/2701)) ([81d7b06](https://github.com/LayerC0de/career-ops-fork/commit/81d7b069a8a726468d9ca76ebb2d9e768b470f01))
* **assessment-log:** reject unknown flags ([#2802](https://github.com/LayerC0de/career-ops-fork/issues/2802)) ([ce56efe](https://github.com/LayerC0de/career-ops-fork/commit/ce56efe8ae6902924256c8257fe8b1b3ab3fdff7))
* **batch-runner:** tab-IFS collapse recorded score "-" for every successful offer ([5b312bf](https://github.com/LayerC0de/career-ops-fork/commit/5b312bf57e49147e8273b2e8f3986155f134b109))
* **batch-tailor:** --min-score 4.5 was silently ignored, and the worker's pdf mode path was cwd-relative ([#2961](https://github.com/LayerC0de/career-ops-fork/issues/2961)) ([f306801](https://github.com/LayerC0de/career-ops-fork/commit/f30680152a54db92bf996120f08a91893a51db44))
* **batch:** don't mark a worker-reported failure as completed ([c7b9519](https://github.com/LayerC0de/career-ops-fork/commit/c7b951907930a90d3a58888b89aa002f77a3477c))
* **batch:** retry state updates and lock reservations to prevent worker silent drops ([#2417](https://github.com/LayerC0de/career-ops-fork/issues/2417)) ([5404185](https://github.com/LayerC0de/career-ops-fork/commit/5404185deff59f8604014c63060458d0b22c640c))
* **batch:** update Claude tier mapping to the current model lineup ([867e374](https://github.com/LayerC0de/career-ops-fork/commit/867e374e1fa7839944c90fc55d3dc6c5e3d1a768))
* **build-cv-html:** render numeric year/date scalars instead of dropping them ([#2641](https://github.com/LayerC0de/career-ops-fork/issues/2641)) ([949a690](https://github.com/LayerC0de/career-ops-fork/commit/949a6900602d5df31aa2b7d1b7b40279de5b1fae))
* **build-cv-latex:** numeric year/date scalars are still dropped — [#2641](https://github.com/LayerC0de/career-ops-fork/issues/2641) fixed only the HTML mirror ([#2916](https://github.com/LayerC0de/career-ops-fork/issues/2916)) ([94eb334](https://github.com/LayerC0de/career-ops-fork/commit/94eb334a03a9837f4a98893e431f61b98264b609))
* **check-table-freshness:** validate CLI flags and add a usage block ([#2873](https://github.com/LayerC0de/career-ops-fork/issues/2873)) ([a12dd6b](https://github.com/LayerC0de/career-ops-fork/commit/a12dd6b355282f4801cd948f063525605c1545ed)), closes [#2855](https://github.com/LayerC0de/career-ops-fork/issues/2855)
* **ci:** a fork signature's valid check must not go red when the ack comment can't post ([5d7b625](https://github.com/LayerC0de/career-ops-fork/commit/5d7b62569cab62dbf05e25942bc8d480c8f7056b))
* **ci:** only greet a first-time contributor when it is actually their first ([a0d45aa](https://github.com/LayerC0de/career-ops-fork/commit/a0d45aaaf4cf2770d702be8e1a3d7e115944aeb2))
* **ci:** skip the upgrade leg when nothing managed changed, instead of failing ([#2697](https://github.com/LayerC0de/career-ops-fork/issues/2697)) ([9dcfd2f](https://github.com/LayerC0de/career-ops-fork/commit/9dcfd2f668628879539c2ccfb3f17ce67f2824eb))
* **classify-tier:** an incidental senior word outranked an explicit intern marker ([#2737](https://github.com/LayerC0de/career-ops-fork/issues/2737)) ([cc2b1ce](https://github.com/LayerC0de/career-ops-fork/commit/cc2b1ce1edbc253f286da33ab9475adb9b46f22e))
* **classify-tier:** validate CLI flags and add a usage block ([#2870](https://github.com/LayerC0de/career-ops-fork/issues/2870)) ([010ccc5](https://github.com/LayerC0de/career-ops-fork/commit/010ccc5eb6be486335c2b973a80605cbfc0eaf45))
* **cli:** --flag=value was silently ignored in five scripts ([37055d7](https://github.com/LayerC0de/career-ops-fork/commit/37055d7de76bf400eb8aa8ed399efca293deadf2))
* **cli:** a one-letter typo returned a false all-clear at exit 0 in 4 reporting CLIs ([#2920](https://github.com/LayerC0de/career-ops-fork/issues/2920)) ([d65d024](https://github.com/LayerC0de/career-ops-fork/commit/d65d0247183a10d115cedbf6dbda83dccf0fa765))
* **company-funded:** catch the layoff spellings [#2404](https://github.com/LayerC0de/career-ops-fork/issues/2404) left through ([aca8b71](https://github.com/LayerC0de/career-ops-fork/commit/aca8b71de30d2a883b9ac8013801bb3d6f4d2a3c))
* **company-funded:** the cuts N% layoff exclusion never matched ([#2404](https://github.com/LayerC0de/career-ops-fork/issues/2404)) ([476b21b](https://github.com/LayerC0de/career-ops-fork/commit/476b21be740ee2399a5c0209641c91a4c8d6bd41))
* **company-history:** count a hire as a company response ([#2297](https://github.com/LayerC0de/career-ops-fork/issues/2297)) ([c6220bf](https://github.com/LayerC0de/career-ops-fork/commit/c6220bf1e414b37e9fb0aec6bc6e68c47189b94b))
* **company-history:** record response dates via --on, not --note free text ([9b17a8a](https://github.com/LayerC0de/career-ops-fork/commit/9b17a8ac97b398a496b38e423ae24e433b43254f))
* **contacto:** LinkedIn connection-request limit is 200 on free tier, not 300 ([#2951](https://github.com/LayerC0de/career-ops-fork/issues/2951)) ([9c242c5](https://github.com/LayerC0de/career-ops-fork/commit/9c242c575ed0bd4d8e9591a3546b255464303f20))
* **contacts:** add -h/--help and reject unrecognized flags ([#2829](https://github.com/LayerC0de/career-ops-fork/issues/2829)) ([0aa3299](https://github.com/LayerC0de/career-ops-fork/commit/0aa3299b2e4d6a1d1b1d88fb8a52dc688e902afb))
* **cover:** fail on an unresolved template token instead of shipping it into the letter ([#2586](https://github.com/LayerC0de/career-ops-fork/issues/2586)) ([3733414](https://github.com/LayerC0de/career-ops-fork/commit/3733414d6440c3f9c6834c4c2ac73245ef25d778))
* **cover:** prevent double comma in achievement bullets ([#2254](https://github.com/LayerC0de/career-ops-fork/issues/2254)) ([31ddafb](https://github.com/LayerC0de/career-ops-fork/commit/31ddafb5c52d3ef368469046011a6d3cadc48358))
* **csod:** replay bootstrap session cookies and repair fetchResponse() ([#2769](https://github.com/LayerC0de/career-ops-fork/issues/2769)) ([7aee3b9](https://github.com/LayerC0de/career-ops-fork/commit/7aee3b9f3bb44b8d4c34adf46a473afcc71ac97f))
* **cv-facts:** the anti-fabrication gate saw nothing in five shipped locales ([599dd82](https://github.com/LayerC0de/career-ops-fork/commit/599dd820fcb73e67eee20b46e88d516f3b349acc))
* **cv-facts:** the employer/title gate only matched lowercase triggers ([a05c270](https://github.com/LayerC0de/career-ops-fork/commit/a05c270ec21b025f75f072751ae0a4acc65c02e0))
* **cv-facts:** treat a k/M/B magnitude suffix as part of the number ([#2612](https://github.com/LayerC0de/career-ops-fork/issues/2612)) ([18d245a](https://github.com/LayerC0de/career-ops-fork/commit/18d245aa9edbfb99a6df90d5df8b6c63c971e549))
* **cv-latex:** single mailto: scheme + escape OT1-unsafe glyphs ([#2378](https://github.com/LayerC0de/career-ops-fork/issues/2378)) ([654dce2](https://github.com/LayerC0de/career-ops-fork/commit/654dce2120e342ea9f1fb89e94a2fd597d47cf29))
* **cv:** an empty Skills section no longer deletes the sections after it ([199b7d6](https://github.com/LayerC0de/career-ops-fork/commit/199b7d68941362134e8ba9ae08d68c1d7c117b08))
* **cv:** drop empty Skills section instead of rendering a bare header ([#2516](https://github.com/LayerC0de/career-ops-fork/issues/2516)) ([60c4db9](https://github.com/LayerC0de/career-ops-fork/commit/60c4db955d19f7267e1722d9b2a8216843ba3cb3))
* **cv:** Korean and Traditional Chinese CVs had no font rule ([#2616](https://github.com/LayerC0de/career-ops-fork/issues/2616)) ([994552d](https://github.com/LayerC0de/career-ops-fork/commit/994552dc5d3faecacdf23f56e21e1b845fbf1aa7))
* **cv:** pair _EMPTY fallbacks with their block so mixed rows stay aligned ([#2486](https://github.com/LayerC0de/career-ops-fork/issues/2486)) ([57af06b](https://github.com/LayerC0de/career-ops-fork/commit/57af06ba78515eb22c835adfef65ce5b45cc94eb))
* **cv:** pass a replacer function so $-patterns in candidate text stay literal ([#2588](https://github.com/LayerC0de/career-ops-fork/issues/2588)) ([097dac0](https://github.com/LayerC0de/career-ops-fork/commit/097dac0c8b811e2145449b6392e56b5d3f2a7fa5))
...
* **dashboard:** persist status changes from viewer Discard/SKIP and stale rows ([#1849](https://github.com/LayerC0de/career-ops-fork/issues/1849)) ([3f4f947](https://github.com/LayerC0de/career-ops-fork/commit/3f4f947ca55b4b64a2893c8077e8e20c1106a554))
* **dashboard:** pin the row's own status to the top of the status picker ([f214d03](https://github.com/LayerC0de/career-ops-fork/commit/f214d0355118735939fcf3339b263d7769514f19))
* **dashboard:** stop reading funding and valuation figures as Pay ([#2139](https://github.com/LayerC0de/career-ops-fork/issues/2139)) ([581374f](https://github.com/LayerC0de/career-ops-fork/commit/581374f25ca971d7b8161ca94d34fc9de9236cd5))
* **dashboard:** the 'hired' status renders with no colour in the pipeline list ([8465462](https://github.com/LayerC0de/career-ops-fork/commit/8465462c9dd82ef9ced62395126f2c8455871cb6))
* **dashboard:** the progress funnel dropped Hired from every stage ([#2406](https://github.com/LayerC0de/career-ops-fork/issues/2406)) ([aac93e8](https://github.com/LayerC0de/career-ops-fork/commit/aac93e82809a345430c6e7fe89263cfb6aa86416))
* **dedup-tracker:** reject unrecognized flags instead of silently live-running ([#2746](https://github.com/LayerC0de/career-ops-fork/issues/2746)) ([429b0dc](https://github.com/LayerC0de/career-ops-fork/commit/429b0dc8aa2418480c7c3548d7e67612564b960d))
* **dedup:** merge notes from removed entries instead of dropping them ([#1883](https://github.com/LayerC0de/career-ops-fork/issues/1883)) ([a91aebf](https://github.com/LayerC0de/career-ops-fork/commit/a91aebf974304fb284b8e7c8e7719d6a9222d2b0)), closes [#1833](https://github.com/LayerC0de/career-ops-fork/issues/1833)
* **dedup:** use the shared Unicode-aware company key instead of a local ASCII copy ([#2587](https://github.com/LayerC0de/career-ops-fork/issues/2587)) ([130e3fa](https://github.com/LayerC0de/career-ops-fork/commit/130e3fa073e37655178566312ea741bfba24866c))
* **dedup:** use Unicode-aware Via key for blind-employer grouping ([#2397](https://github.com/LayerC0de/career-ops-fork/issues/2397)) ([fe4561b](https://github.com/LayerC0de/career-ops-fork/commit/fe4561b0686b8e2829d5cf6c8d7bbdedb9bfb7cd))
* **dedup:** write the blind-via key prefix as an escape, not a raw NUL byte ([1b57bb6](https://github.com/LayerC0de/career-ops-fork/commit/1b57bb65f30a1614dbd55e6dd6729357a767b7a7))
...
* **doctor:** detect Playwright MCP in JSONC OpenCode configs ([#2252](https://github.com/LayerC0de/career-ops-fork/issues/2252)) ([ead7985](https://github.com/LayerC0de/career-ops-fork/commit/ead7985f9fa2f2770cc6738443662549ff16e1e9))
* **doctor:** detect Playwright MCP servers provided by Claude Code plugins ([#2753](https://github.com/LayerC0de/career-ops-fork/issues/2753)) ([49d20f2](https://github.com/LayerC0de/career-ops-fork/commit/49d20f26dff1b1f1d7d9c783bac714076ebc7444))
* **doctor:** treat the cloud billing switches as opt-in, not merely present ([#2593](https://github.com/LayerC0de/career-ops-fork/issues/2593)) ([acbd060](https://github.com/LayerC0de/career-ops-fork/commit/acbd06061d1ef90eef09a3a81cd4e3d6b7467247)), closes [#2592](https://github.com/LayerC0de/career-ops-fork/issues/2592)
* **doctor:** validate CLI flags and add a usage block ([#2874](https://github.com/LayerC0de/career-ops-fork/issues/2874)) ([d4c31be](https://github.com/LayerC0de/career-ops-fork/commit/d4c31be403453249abe039c3ebc50cb7e56f7539)), closes [#2856](https://github.com/LayerC0de/career-ops-fork/issues/2856)
* **echojobs:** keep hybrid roles distinguishable from remote ([#2258](https://github.com/LayerC0de/career-ops-fork/issues/2258)) ([0ef7c23](https://github.com/LayerC0de/career-ops-fork/commit/0ef7c23672a572abc8dc54d53cdefd5f065e086b))
* **eval:** merge openrouter tracker TSVs and send Ollama options to the native /api/chat ([#2647](https://github.com/LayerC0de/career-ops-fork/issues/2647)) ([a86f776](https://github.com/LayerC0de/career-ops-fork/commit/a86f776a252ec1fa608dcd3ab61c4f6f1b678754))
* extend the backup-file ignore to .npmignore and pin it with a test ([#2560](https://github.com/LayerC0de/career-ops-fork/issues/2560)) ([f0e7a5d](https://github.com/LayerC0de/career-ops-fork/commit/f0e7a5db4fd0b0952492723227f62fb51741cbd6))
* **find:** print the one USAGE constant on the empty-query path too ([f0dd6ed](https://github.com/LayerC0de/career-ops-fork/commit/f0dd6edb9387f1b8ff4bbb4b69e62f8982fc3f7c))
* **find:** reject mistyped flags instead of searching for them ([9265e08](https://github.com/LayerC0de/career-ops-fork/commit/9265e08188719bbf06891c8efc2ae10fa0991b63))
* **fingerprint:** non-Latin employers no longer collapse to the same company key ([#2501](https://github.com/LayerC0de/career-ops-fork/issues/2501)) ([9326a04](https://github.com/LayerC0de/career-ops-fork/commit/9326a04102e5b8ef517532f4dea94f8688727332))
* **followup-cadence:** parse annotated pins, and add a retire directive ([#2514](https://github.com/LayerC0de/career-ops-fork/issues/2514)) ([b4f6b2d](https://github.com/LayerC0de/career-ops-fork/commit/b4f6b2dd4b55c8172e56ef776f1e4fd82bce4acf))
* **followup-seed:** age out an orphaned recover guard so it can't permanently disable stale-lock recovery ([799b3f8](https://github.com/LayerC0de/career-ops-fork/commit/799b3f86c2e40edec980d44704aa92f512312e13))
* **followup-seed:** resolve "today" in local time, not UTC ([#2765](https://github.com/LayerC0de/career-ops-fork/issues/2765)) ([15aa769](https://github.com/LayerC0de/career-ops-fork/commit/15aa7697292d3afe2fc557626beda74a12a4523a))
* **followup:** accept an estimated apply date and report which date the age came from ([14a4003](https://github.com/LayerC0de/career-ops-fork/commit/14a40030f51891e93c5a026ab388a0253aca0250))
* **followup:** ignore an apply date cited about another row ([#2610](https://github.com/LayerC0de/career-ops-fork/issues/2610)) ([53808a9](https://github.com/LayerC0de/career-ops-fork/commit/53808a91745594685be3118e1792aa4ad0e6ee51)), closes [#2607](https://github.com/LayerC0de/career-ops-fork/issues/2607)
* **followup:** recognise name-only outreach so an empty contact list means no contact ([6d32f33](https://github.com/LayerC0de/career-ops-fork/commit/6d32f33589608a7d8e0e95c6a48d6dd8e198b2f8))
* git-ignore article-digest.md and guard the user layer against tracking ([#2365](https://github.com/LayerC0de/career-ops-fork/issues/2365)) ([e8a33cf](https://github.com/LayerC0de/career-ops-fork/commit/e8a33cf4ca26971b3e26050346800caec43b81fe))
* **http:** consolidate duplicated User-Agent strings into a shared module ([#2536](https://github.com/LayerC0de/career-ops-fork/issues/2536)) ([c8e9a6f](https://github.com/LayerC0de/career-ops-fork/commit/c8e9a6f7bee926a92a9f8cf16ef9403be8b9942e))
* **invite-match:** non-Latin company names returned zero candidates ([#2517](https://github.com/LayerC0de/career-ops-fork/issues/2517)) ([df43774](https://github.com/LayerC0de/career-ops-fork/commit/df43774c4df0c24acd48791ea513e41598af3757))
* **invite-match:** validate CLI flags and add usage ([#2958](https://github.com/LayerC0de/career-ops-fork/issues/2958)) ([34b1d58](https://github.com/LayerC0de/career-ops-fork/commit/34b1d58ff954b83f7cb797317c1bbc5aaafdacd8))
* **jd-similarity:** add --help and reject unknown flags instead of reading them as paths ([#2819](https://github.com/LayerC0de/career-ops-fork/issues/2819)) ([ce1f321](https://github.com/LayerC0de/career-ops-fork/commit/ce1f321388b4f2c36f2dd112da2e7d99abdc44ba)), closes [#2772](https://github.com/LayerC0de/career-ops-fork/issues/2772)
* **jd-similarity:** the seniority gate fired on JD boilerplate ([#2661](https://github.com/LayerC0de/career-ops-fork/issues/2661)) ([772ea35](https://github.com/LayerC0de/career-ops-fork/commit/772ea35153f88a101c3d22da1741cb79804fae4d))
* **jd-skill-gap:** canonicalize CV and JD tokens through skill-extract ([#2226](https://github.com/LayerC0de/career-ops-fork/issues/2226)) ([dbaa761](https://github.com/LayerC0de/career-ops-fork/commit/dbaa761d10abaf34e52684e04fb996a0625e70fc))
* **jd-skill-gap:** CRLF-terminated JDs extracted zero skills ([fa16f09](https://github.com/LayerC0de/career-ops-fork/commit/fa16f095f02605009e7bd603bba94149b99fef96))
* **jd-skill-gap:** recognize all six markdown heading levels ([#2721](https://github.com/LayerC0de/career-ops-fork/issues/2721)) ([2a3bd2f](https://github.com/LayerC0de/career-ops-fork/commit/2a3bd2f1f75580824ee0be1f26e93d54f0be18af))
* **jd-skill-gap:** recognize sentence-form requirement headings ([#2686](https://github.com/LayerC0de/career-ops-fork/issues/2686)) ([fd9ca41](https://github.com/LayerC0de/career-ops-fork/commit/fd9ca41d372886b1c095b8ba689e48950da6260f))
* **jd-skill-gap:** warn when zero skills are classified instead of printing a clean summary ([#2341](https://github.com/LayerC0de/career-ops-fork/issues/2341)) ([9e3586d](https://github.com/LayerC0de/career-ops-fork/commit/9e3586da3e4a54291e2ddab07e218e09cbd76b92))
* **jobvite:** migrate to the public XML feed after the JSON API retirement ([#2623](https://github.com/LayerC0de/career-ops-fork/issues/2623)) ([0c7522b](https://github.com/LayerC0de/career-ops-fork/commit/0c7522b408f0f62d334972a34fcf1ece2a55541c))
...
* **liveness:** classify a rate-limited posting as uncertain, not expired ([#2613](https://github.com/LayerC0de/career-ops-fork/issues/2613)) ([c65afe6](https://github.com/LayerC0de/career-ops-fork/commit/c65afe6f508105d84da75fddb026b077afd9bbc0))
* **liveness:** classify transient 5xx as uncertain, not expired ([#2371](https://github.com/LayerC0de/career-ops-fork/issues/2371)) ([6958d84](https://github.com/LayerC0de/career-ops-fork/commit/6958d848085cbecae4adc800e75eebce3eca35b7))
* **liveness:** normalize typographic punctuation and accents before matching ([#2163](https://github.com/LayerC0de/career-ops-fork/issues/2163)) ([105ec60](https://github.com/LayerC0de/career-ops-fork/commit/105ec606737cce5c626aaa1f1ab7448acb860d9f)), closes [#2162](https://github.com/LayerC0de/career-ops-fork/issues/2162)
* **liveness:** read same-origin iframes so embedded postings aren't false negatives ([#2884](https://github.com/LayerC0de/career-ops-fork/issues/2884)) ([bd36aa5](https://github.com/LayerC0de/career-ops-fork/commit/bd36aa5990beac49bc9dd24549fffc6b765c5997))
* **liveness:** treat an api.lever.co 404 as inconclusive, not proof of removal ([#2649](https://github.com/LayerC0de/career-ops-fork/issues/2649)) ([84fe20f](https://github.com/LayerC0de/career-ops-fork/commit/84fe20f0cebc6500fc85939752ff946dc43e1de7))
* **liveness:** treat the SPA "has been filled" phrasing as expired ([#2212](https://github.com/LayerC0de/career-ops-fork/issues/2212)) ([112298c](https://github.com/LayerC0de/career-ops-fork/commit/112298c84181884613646c40bc4e90251c86696a)), closes [#2211](https://github.com/LayerC0de/career-ops-fork/issues/2211)
* **locks:** the other two copies of the protocol had the same Windows bug ([#3033](https://github.com/LayerC0de/career-ops-fork/issues/3033)) ([1f73f2e](https://github.com/LayerC0de/career-ops-fork/commit/1f73f2eabbbf4376a9103cc1619a98a72682512b))
* **locks:** treat Windows rm/stat contention as contention, not death ([#2984](https://github.com/LayerC0de/career-ops-fork/issues/2984)) ([2743281](https://github.com/LayerC0de/career-ops-fork/commit/27432818d29faf67103714e12f6777bf39239c67))
* **match-star:** score a non-English story bank against a question in its own language ([#2848](https://github.com/LayerC0de/career-ops-fork/issues/2848)) ([fa5926d](https://github.com/LayerC0de/career-ops-fork/commit/fa5926df06c348e18459a6c8f5328c93c8641d5a))
* **merge-tracker:** collapse placeholder Notes to the re-eval marker ([#2483](https://github.com/LayerC0de/career-ops-fork/issues/2483)) ([0df8a41](https://github.com/LayerC0de/career-ops-fork/commit/0df8a416117cfd66a3e747ad1a602c0a995380ed))
* **merge-tracker:** deterministic dedup on the posting URL ([#1298](https://github.com/LayerC0de/career-ops-fork/issues/1298)) ([a0426bb](https://github.com/LayerC0de/career-ops-fork/commit/a0426bb9ef06744f59d67e17014dd4c7fda59e17))
* **merge-tracker:** four silent data-loss paths in the merge loop, with Unicode-safe company matching ([#2399](https://github.com/LayerC0de/career-ops-fork/issues/2399)) ([7bcae6b](https://github.com/LayerC0de/career-ops-fork/commit/7bcae6be777d029fe9bc6cfb3048a80f9c2bea96))
* **merge-tracker:** match inline URL headers so URL dedup activates for doc-style rows ([#2926](https://github.com/LayerC0de/career-ops-fork/issues/2926)) ([c078513](https://github.com/LayerC0de/career-ops-fork/commit/c078513127aa13bd02edb2a2cbadad34da20615b))
* **merge-tracker:** re-eval no longer inherits the superseded report's checkmark ([#2595](https://github.com/LayerC0de/career-ops-fork/issues/2595)) ([c85d02f](https://github.com/LayerC0de/career-ops-fork/commit/c85d02fda92f93d3d97fe273b05059397be1ab87))
* **merge-tracker:** stop sibling-req clobber when the qualifier is a slashed acronym ([#2166](https://github.com/LayerC0de/career-ops-fork/issues/2166)) ([4910e73](https://github.com/LayerC0de/career-ops-fork/commit/4910e7398fb16442357db6a1cbe055afb1c28652))
* **merge-tracker:** write a lower-scored re-evaluation through instead of discarding it ([9036809](https://github.com/LayerC0de/career-ops-fork/commit/90368097c57f9f6ad5ee60efa67415f19d1e54db))
* **merge-tracker:** write rows at the header's actual width on customized trackers ([8668ac1](https://github.com/LayerC0de/career-ops-fork/commit/8668ac1a0d37676a8540be54724333b57240ec6d))
* **normalize-statuses:** use header-mapped columns instead of fixed indices ([cf0bf4f](https://github.com/LayerC0de/career-ops-fork/commit/cf0bf4f0ad9a85106dc107ee0bb9b6ac89ef343a))
* **ollama:** include profile context in evaluations ([#2664](https://github.com/LayerC0de/career-ops-fork/issues/2664)) ([ef2a82f](https://github.com/LayerC0de/career-ops-fork/commit/ef2a82f6970302733c35ebba9b3a30ec5fac65f1))
* **opencode:** add missing /career-ops command router ([#2204](https://github.com/LayerC0de/career-ops-fork/issues/2204)) ([74bd6f2](https://github.com/LayerC0de/career-ops-fork/commit/74bd6f2085c350e1d53eeba0e6143df65d537279)), closes [#2191](https://github.com/LayerC0de/career-ops-fork/issues/2191)
* **oraclecloud:** accept Oracle's numbered tenant apexes (oraclecloud1-99.com) ([#2683](https://github.com/LayerC0de/career-ops-fork/issues/2683)) ([a23ebc1](https://github.com/LayerC0de/career-ops-fork/commit/a23ebc1a2f88a16db98af9f3a16e8c4041b5bded))
* **patterns:** rate denominators counted rows that could never contribute ([#2783](https://github.com/LayerC0de/career-ops-fork/issues/2783)) ([e2dbbbf](https://github.com/LayerC0de/career-ops-fork/commit/e2dbbbfcd79c205a5589be0907921d846e299ddb))
* **patterns:** recognize the canonical Hired status in analyze-patterns ([#2145](https://github.com/LayerC0de/career-ops-fork/issues/2145)) ([283b2a0](https://github.com/LayerC0de/career-ops-fork/commit/283b2a0cee5fbb76f286d4983648dbf37a01b763))
* **pdf:** apply the CV section-order check to non-English CVs ([#2088](https://github.com/LayerC0de/career-ops-fork/issues/2088)) ([9a82618](https://github.com/LayerC0de/career-ops-fork/commit/9a8261871df0c8cbdc1dc18eee9312e45d24a3e5))
* **pipeline-lock:** a non-EEXIST mkdir refusal is contention, not a fatal error ([#2838](https://github.com/LayerC0de/career-ops-fork/issues/2838)) ([bca798f](https://github.com/LayerC0de/career-ops-fork/commit/bca798f8a61b1bbcd93da17c04d17eccbba627b6)), closes [#2777](https://github.com/LayerC0de/career-ops-fork/issues/2777)
* **pipeline-lock:** an unreadable owner stamp is not an ownerless lock ([bb537c6](https://github.com/LayerC0de/career-ops-fork/commit/bb537c630f46174d7dc452c21d5b804f628cb5ff))
* **pipeline-lock:** floor the ownerless stale check, harden the timeout tests ([4720e20](https://github.com/LayerC0de/career-ops-fork/commit/4720e20f45c34c14d3fff807880ff9e0e23a0ef4))
* **pipeline-lock:** jitter the retry so a starved writer costs a retry, not an item ([c7dbf0d](https://github.com/LayerC0de/career-ops-fork/commit/c7dbf0d9b7fed227129340055655303a955b567b))
* **pipeline-lock:** time out a wedged holder, not an unlucky waiter ([098bad0](https://github.com/LayerC0de/career-ops-fork/commit/098bad01b899c4ce3c3d3946957d654379b9a5c7))
* **pipeline:** lock appendToPipeline() against concurrent read-modify-write ([#2189](https://github.com/LayerC0de/career-ops-fork/issues/2189)) ([3c04b43](https://github.com/LayerC0de/career-ops-fork/commit/3c04b43c9dde809e1bda5a8d6d667c4124cf58ce)), closes [#2188](https://github.com/LayerC0de/career-ops-fork/issues/2188)
* **plugin-audit:** validate CLI arguments and add a usage block ([#2813](https://github.com/LayerC0de/career-ops-fork/issues/2813)) ([588139c](https://github.com/LayerC0de/career-ops-fork/commit/588139c629eab04c69a868469b921cb01b013ae3)), closes [#2771](https://github.com/LayerC0de/career-ops-fork/issues/2771)
* **portals:** block German student and support postings in the example title filter ([6a3dbc2](https://github.com/LayerC0de/career-ops-fork/commit/6a3dbc290d3c1d5805bc40002d2d0010aa876666))
* **process-quality:** three undisclosed employers were reported as disclosed ([#3005](https://github.com/LayerC0de/career-ops-fork/issues/3005)) ([b5acfa5](https://github.com/LayerC0de/career-ops-fork/commit/b5acfa513bc16896f0310affaa835c4a1bb21f04))
* **providers:** a16z speedrun feed silently truncates to 50 jobs ([4abcb32](https://github.com/LayerC0de/career-ops-fork/commit/4abcb3224c506ea05cccf8d67acc4610f8a2a4bc))
* **providers:** dead boards throw instead of reading as live-but-empty ([#2379](https://github.com/LayerC0de/career-ops-fork/issues/2379)) ([3c331e4](https://github.com/LayerC0de/career-ops-fork/commit/3c331e43662226464fcbfb1dc32985e4646afc5b))
* **providers:** decode HTML entities in titles before matching so encoded ampersands stop dropping jobs ([#2923](https://github.com/LayerC0de/career-ops-fork/issues/2923)) ([37f4c11](https://github.com/LayerC0de/career-ops-fork/commit/37f4c11b4ad5e3aca94aa389453806b3a6210535))
* **providers:** fill in the docs and vendor-detection gaps ([#2658](https://github.com/LayerC0de/career-ops-fork/issues/2658)) ([7152907](https://github.com/LayerC0de/career-ops-fork/commit/7152907e88fd2daa05c83f8351ea873f8296e072))
* **providers:** hackernews thread lookup filters by the whoishiring tag ([3aa5e15](https://github.com/LayerC0de/career-ops-fork/commit/3aa5e159d7c135c7e40f4677475f4b6cbc8583bd))
* **providers:** harden workable with retry, headers, and serialization ([#2675](https://github.com/LayerC0de/career-ops-fork/issues/2675)) ([feabcd4](https://github.com/LayerC0de/career-ops-fork/commit/feabcd45b3615af6d8871f89f17246dbbab3a811))
* **providers:** isRetryableError no longer misclassifies a refused redirect ([#2657](https://github.com/LayerC0de/career-ops-fork/issues/2657)) ([f8feaa5](https://github.com/LayerC0de/career-ops-fork/commit/f8feaa53c3f7bb8cf0cc33196d0ca3bf999951da))
* **providers:** make themuse resilient to per-page fetch failures ([#2682](https://github.com/LayerC0de/career-ops-fork/issues/2682)) ([a83800f](https://github.com/LayerC0de/career-ops-fork/commit/a83800feac3c15017365c6d6b6acb69509757f20))
* **providers:** move The Hub to the v2 jobsandfeatured API ([6b33fc4](https://github.com/LayerC0de/career-ops-fork/commit/6b33fc45f3d4abe15be300fd0b3c9cf4999c57ff))
* **providers:** personio falls back to HTML scrape when the XML feed is disabled ([5fe2784](https://github.com/LayerC0de/career-ops-fork/commit/5fe27841b7839d7b8ea5a7f5c753408b4f24f03c))
* **providers:** phenom pagination/retry fixes, drop dead auto-detection ([#2669](https://github.com/LayerC0de/career-ops-fork/issues/2669)) ([1331ebf](https://github.com/LayerC0de/career-ops-fork/commit/1331ebfcb805d3714d2e6c81b2b9e22395b80540))
* **providers:** reject numeric entities outside the XML 1.0 Char set ([#2713](https://github.com/LayerC0de/career-ops-fork/issues/2713)) ([a050631](https://github.com/LayerC0de/career-ops-fork/commit/a0506312b67a26560022415b5b5abdf3a99ca8ad))
* **providers:** resize a16z page budgets for the 50-job page size ([36d0c44](https://github.com/LayerC0de/career-ops-fork/commit/36d0c444534f518fc127d70b81590aa1d2a3bf1a))
* **providers:** route seven RSS decoders through the shared safe entity decoder ([#2818](https://github.com/LayerC0de/career-ops-fork/issues/2818)) ([5b00081](https://github.com/LayerC0de/career-ops-fork/commit/5b00081f1a74354c1924177985d1576e50ddcef1)), closes [#2790](https://github.com/LayerC0de/career-ops-fork/issues/2790)
* **providers:** route softgarden and radancy through the shared entity decoder ([#2487](https://github.com/LayerC0de/career-ops-fork/issues/2487)) ([96b1de6](https://github.com/LayerC0de/career-ops-fork/commit/96b1de6806dd2630f4c26b19cf37c6ca98638d07))
* **providers:** senjob was the fifth private entity decoder, and the weakest — it emitted C0 controls ([aa21e92](https://github.com/LayerC0de/career-ops-fork/commit/aa21e9296e2c1c54b82887641ed7b843c3e3cf37))
* **reply-matcher:** require corroboration for partial role-title matches ([#2672](https://github.com/LayerC0de/career-ops-fork/issues/2672)) ([3215fa3](https://github.com/LayerC0de/career-ops-fork/commit/3215fa309d5158d2ea51a97a5074792e1d9138d7))
* **reply-matcher:** the '?' unknown-employer placeholder matched everything ([#3001](https://github.com/LayerC0de/career-ops-fork/issues/3001)) ([86e653d](https://github.com/LayerC0de/career-ops-fork/commit/86e653d5b08bbf81781c0f84b6c567dbe79e571f))
* **reply-watch:** reject unrecognized CLI flags instead of treating them as a path ([#2745](https://github.com/LayerC0de/career-ops-fork/issues/2745)) ([ba2b634](https://github.com/LayerC0de/career-ops-fork/commit/ba2b6340d8802125789203e5f2deb5084c04857b))
* **repo:** add .gitattributes so Windows checkouts stop producing whole-file diffs ([80d104f](https://github.com/LayerC0de/career-ops-fork/commit/80d104f994ba1e64a09b7a92a0d86641308cf64a))
* **reserve-report-num:** do not read a bare date file as a report number ([#2759](https://github.com/LayerC0de/career-ops-fork/issues/2759)) ([6d6524b](https://github.com/LayerC0de/career-ops-fork/commit/6d6524b30694c7a870df3aacdf7075ce524c4ee8)), closes [#2757](https://github.com/LayerC0de/career-ops-fork/issues/2757)
* resolve the PDF manifest from the tracker, not the install dir ([#2471](https://github.com/LayerC0de/career-ops-fork/issues/2471)) ([bc73c7f](https://github.com/LayerC0de/career-ops-fork/commit/bc73c7fd75192edf8d4927de7339c6cbb6eeaa05))
* restore empty-Certifications section stripping lost in the v1.22.0 refactor ([#2119](https://github.com/LayerC0de/career-ops-fork/issues/2119)) ([708c53d](https://github.com/LayerC0de/career-ops-fork/commit/708c53de87374863e621187c0b43e4c374194b59)), closes [#2118](https://github.com/LayerC0de/career-ops-fork/issues/2118)
* **role-matcher:** fold accented Latin letters before tokenizing role titles ([#2209](https://github.com/LayerC0de/career-ops-fork/issues/2209)) ([830fe51](https://github.com/LayerC0de/career-ops-fork/commit/830fe511d04dce244b1ea20941a94b26a9d38d97)), closes [#2207](https://github.com/LayerC0de/career-ops-fork/issues/2207)
* **role-matcher:** stop collapsing leveled variants into the bare title ([fd8f721](https://github.com/LayerC0de/career-ops-fork/commit/fd8f72191f8db255638015902c7439b1982643fe))
* **role-matcher:** strip the "Member of Technical Staff" prefix before tokenizing ([#1933](https://github.com/LayerC0de/career-ops-fork/issues/1933)) ([a113766](https://github.com/LayerC0de/career-ops-fork/commit/a113766b7877ab1b2711348dec7802df30a865df)), closes [#1965](https://github.com/LayerC0de/career-ops-fork/issues/1965)
* **role-matcher:** tokenize non-Latin role titles and scope the mark fold ([#2782](https://github.com/LayerC0de/career-ops-fork/issues/2782)) ([6704dd6](https://github.com/LayerC0de/career-ops-fork/commit/6704dd6cf4fc957c9a4a085459ee64ba73fc8f7c)), closes [#2781](https://github.com/LayerC0de/career-ops-fork/issues/2781)
* **role-matcher:** treat 'product' as a baseline token so PM sibling specialties stay distinct ([#2164](https://github.com/LayerC0de/career-ops-fork/issues/2164)) ([37c0e99](https://github.com/LayerC0de/career-ops-fork/commit/37c0e99978203027b43d129bda5786d31e485ce7))
* **salary-gap:** parse US ranges with the currency symbol on both bounds ([#2200](https://github.com/LayerC0de/career-ops-fork/issues/2200)) ([9d77fd4](https://github.com/LayerC0de/career-ops-fork/commit/9d77fd49e3ea185f352d29869a773b7263f5f059)), closes [#2190](https://github.com/LayerC0de/career-ops-fork/issues/2190)
* **scaffolder:** materialize the Kimi skill entrypoint on symlink-less filesystems ([#2259](https://github.com/LayerC0de/career-ops-fork/issues/2259)) ([06da05c](https://github.com/LayerC0de/career-ops-fork/commit/06da05c67283ce2c18c4c52e25ea7aee2d89d5ea))
* **scan-ats-full:** --since -5 silently scanned nothing and called it a clean run ([#2498](https://github.com/LayerC0de/career-ops-fork/issues/2498)) ([8a10c01](https://github.com/LayerC0de/career-ops-fork/commit/8a10c010f29052f2a252f103ab1f6950aa9ba172))
* **scan-ats-full:** cap single-host ATS sweeps at their own concurrency ([#2839](https://github.com/LayerC0de/career-ops-fork/issues/2839)) ([5ef0676](https://github.com/LayerC0de/career-ops-fork/commit/5ef0676a3b304e48325031070358d547d65b70de))
* **scan-ats-full:** keep the checkpoint when a resolver outage stops a sweep ([#2283](https://github.com/LayerC0de/career-ops-fork/issues/2283)) ([5764c35](https://github.com/LayerC0de/career-ops-fork/commit/5764c35778b7ce82a8787ceb31d0fec703b077c6))
* **scan:** a title-stated remote role survives a city-only location ([8c3e806](https://github.com/LayerC0de/career-ops-fork/commit/8c3e806201fa12d7780c4a085c4d8108e5c4b7ad))
* **scan:** ignore StepStone's volatile rltr param when deduping posting URLs ([#1982](https://github.com/LayerC0de/career-ops-fork/issues/1982)) ([b1ae044](https://github.com/LayerC0de/career-ops-fork/commit/b1ae0443d8eec1a1468cc603dc36c3f7e1344fe4))
* **scan:** keep body consumption inside the fetch timeout window ([#2138](https://github.com/LayerC0de/career-ops-fork/issues/2138)) ([643478f](https://github.com/LayerC0de/career-ops-fork/commit/643478f39880b51f9eb1be22112e722fead5902b)), closes [#2136](https://github.com/LayerC0de/career-ops-fork/issues/2136)
* **scan:** locate the URL anywhere in a pipeline.md entry ([#2605](https://github.com/LayerC0de/career-ops-fork/issues/2605)) ([c0413e3](https://github.com/LayerC0de/career-ops-fork/commit/c0413e3ce374b2e6be628a46f9b28422e26d3e85))
* **scan:** lowercase the path in normalizeUrlForDedup to catch cross-source duplicates ([#2089](https://github.com/LayerC0de/career-ops-fork/issues/2089)) ([9c05638](https://github.com/LayerC0de/career-ops-fork/commit/9c0563831cea28816a6aea9051768805483f9d8f))
* **scan:** portal-health cross-process lock + resolve PORTAL_HEALTH_PATH from cwd ([96c578b](https://github.com/LayerC0de/career-ops-fork/commit/96c578b689fc138811dd40ec296ae8c3eca497e7))
* **scan:** read --company/--posted-after/--posted-before in =value form too ([#2589](https://github.com/LayerC0de/career-ops-fork/issues/2589)) ([b629ca0](https://github.com/LayerC0de/career-ops-fork/commit/b629ca09ae9cd4ea7e0ba871513229fee3bb7545))
* **scan:** record auth, server and unknown fetch errors in portal-health instead of reachable ([#2236](https://github.com/LayerC0de/career-ops-fork/issues/2236)) ([2328f46](https://github.com/LayerC0de/career-ops-fork/commit/2328f469ce6575d1582964f35e6265216e045ff6))
* **scan:** recover Greenhouse office cities when location.name is a work model ([#2104](https://github.com/LayerC0de/career-ops-fork/issues/2104)) ([b24b99f](https://github.com/LayerC0de/career-ops-fork/commit/b24b99f1b46b3bffb8d42bcf52191a00f968acda))
...
* **scan:** Unicode-aware keys for role dedup and company matching ([#2569](https://github.com/LayerC0de/career-ops-fork/issues/2569)) ([08cda71](https://github.com/LayerC0de/career-ops-fork/commit/08cda7110a0ba5095ddbcb03857382aa07f3a261))
* **scan:** word-boundary location keywords + URL location fallback ([#2087](https://github.com/LayerC0de/career-ops-fork/issues/2087)) ([8a1ba8a](https://github.com/LayerC0de/career-ops-fork/commit/8a1ba8accac0d5d1f6ef725780709fb205355240))
* **seeds:** walk every YC page instead of stopping after page 1 ([#2526](https://github.com/LayerC0de/career-ops-fork/issues/2526)) ([6cf9e41](https://github.com/LayerC0de/career-ops-fork/commit/6cf9e41952dbe41e4fbe4751558d3107cf3a6924)), closes [#2525](https://github.com/LayerC0de/career-ops-fork/issues/2525)
* **seeds:** walk every YC page instead of stopping after page 1 ([#2558](https://github.com/LayerC0de/career-ops-fork/issues/2558)) ([9424577](https://github.com/LayerC0de/career-ops-fork/commit/9424577c320016ef1ba13406182e5096facf9724))
* **set-status:** close the report-less-row blind spot and add explicit --row/--report selectors ([#2347](https://github.com/LayerC0de/career-ops-fork/issues/2347)) ([292f55d](https://github.com/LayerC0de/career-ops-fork/commit/292f55d49dc10deaa6e96975634b650143eb08e4))
* **set-status:** rejects today's date east of UTC, logs tomorrow's west of it ([2461b3b](https://github.com/LayerC0de/career-ops-fork/commit/2461b3b979fcd6d361a8be555f1cb9fc96728251))
* **set-status:** stop the --role guard from folding every non-Latin title to the same key ([#2736](https://github.com/LayerC0de/career-ops-fork/issues/2736)) ([437da7a](https://github.com/LayerC0de/career-ops-fork/commit/437da7aa2cfaacb0ca9161303627ea7f3ee85569))
* show actual LinkedIn URL as cover-letter link text, not the word "LinkedIn" ([#2338](https://github.com/LayerC0de/career-ops-fork/issues/2338)) ([f04b40e](https://github.com/LayerC0de/career-ops-fork/commit/f04b40e1d1bfbad4a329d2fcc8c24251a8285553))
* **states:** aliases the engine accepts were missing from states.yml ([#2615](https://github.com/LayerC0de/career-ops-fork/issues/2615)) ([04ef492](https://github.com/LayerC0de/career-ops-fork/commit/04ef4925c8271112cfcd9711405b7bbc3ae3025f))
* **status:** fold Turkish dotted capitals so uppercase tracker rows resolve to canonical states ([0834e72](https://github.com/LayerC0de/career-ops-fork/commit/0834e7224b99a130ac09ea6a076f585aac85e85d))
* strip GitHub URL scheme case-insensitively in cover letters ([#2340](https://github.com/LayerC0de/career-ops-fork/issues/2340)) ([0157284](https://github.com/LayerC0de/career-ops-fork/commit/0157284500925b7042707184e547a862da0406fe))
* sync the PDF and scan summary output ([#2213](https://github.com/LayerC0de/career-ops-fork/issues/2213)) ([c47094b](https://github.com/LayerC0de/career-ops-fork/commit/c47094bfe50004c34657b202417d02b2915ba191))
* **sync-pdf:** reject unknown options ([a9b986b](https://github.com/LayerC0de/career-ops-fork/commit/a9b986b78ab68c32b12373b7cd47b4ae839fcca1))
* **tailor:** prompt-cache the openai-tailor.mjs static system prefix ([#2432](https://github.com/LayerC0de/career-ops-fork/issues/2432)) ([1ec3320](https://github.com/LayerC0de/career-ops-fork/commit/1ec33201f80f94d7affb49a9c61193444d3c90aa))
* **test-all:** the states.yml freeze guarded 6 of 9 ids ([#2408](https://github.com/LayerC0de/career-ops-fork/issues/2408)) ([d3acdad](https://github.com/LayerC0de/career-ops-fork/commit/d3acdad1d9db5a053a6be436905efa8c5a12d9a9))
* **test:** accept a materialized skill entrypoint, not just a symlink ([#2273](https://github.com/LayerC0de/career-ops-fork/issues/2273)) ([741fadf](https://github.com/LayerC0de/career-ops-fork/commit/741fadf65e1810645e816fa83d6ffa40ea645e6f))
* **test:** forbid finish() in discovered suites — it forges the global verdict ([cd346d3](https://github.com/LayerC0de/career-ops-fork/commit/cd346d3f0e746aeadcafd2e64dcb0afaaec47d15))
* **test:** make the SYSTEM_PATHS coverage guard actually run in CI ([#2240](https://github.com/LayerC0de/career-ops-fork/issues/2240)) ([b2f3fda](https://github.com/LayerC0de/career-ops-fork/commit/b2f3fda4493677918bb44abee7b15706518c0d37))
* **test:** report the Windows-unobservable lock contention signal instead of failing ([d2b4ccd](https://github.com/LayerC0de/career-ops-fork/commit/d2b4ccd3847aafd5fea71da453080bfaf5c1fcb3))
* **tests:** budget harness waits for slow runners and preserve crashed-script diagnostics ([#2332](https://github.com/LayerC0de/career-ops-fork/issues/2332)) ([e439792](https://github.com/LayerC0de/career-ops-fork/commit/e439792bc58740f83fb153807f02929f500f0759))
* **tests:** contain a discovered suite that throws at import ([#2830](https://github.com/LayerC0de/career-ops-fork/issues/2830)) ([51e8f19](https://github.com/LayerC0de/career-ops-fork/commit/51e8f19513d5cc9e9f26b3a27442f32cebf9e678))
* **tests:** find Git Bash under Scoop and name the fallback shell in failures ([#2366](https://github.com/LayerC0de/career-ops-fork/issues/2366)) ([bff961c](https://github.com/LayerC0de/career-ops-fork/commit/bff961c4756b1f0d9c1baa149ed2af75756a485a))
* **tests:** isolate tracker-columns fixtures from the real reports/ directory ([0f79901](https://github.com/LayerC0de/career-ops-fork/commit/0f79901a756903335fef9e50aa23a248a5135002))
* **test:** stop test-all silently passing when a node:test suite fails ([#2463](https://github.com/LayerC0de/career-ops-fork/issues/2463)) ([7e02444](https://github.com/LayerC0de/career-ops-fork/commit/7e02444aff702ad3b1d5063c5835b53e44d4a9ff))
* **test:** use a junction on Windows for the node_modules link ([241bcfd](https://github.com/LayerC0de/career-ops-fork/commit/241bcfd93a3a0a11242c45fad5483f57806ef019))
* **theme-style:** a `$`-pattern in a profile style value splices the body into the CV's &lt;head&gt; ([1798f3a](https://github.com/LayerC0de/career-ops-fork/commit/1798f3a45e5ec8eb44af634dce5f6703a9c6d874))
* **tracker-utils, followup-seed:** floor the ownerless stale-lock check so a just-created lock can't be stolen ([cfc791d](https://github.com/LayerC0de/career-ops-fork/commit/cfc791d53513c8ab96ac29b76f4b705244b56365))
* **tracker:** a data row containing --- is invisible to merge-tracker dedup ([#2267](https://github.com/LayerC0de/career-ops-fork/issues/2267)) ([2333a0f](https://github.com/LayerC0de/career-ops-fork/commit/2333a0fa4221111d975cd0a2d51d498f853f6d1c))
* **tracker:** non-Latin company names all keyed to empty string, silently overwriting each other ([#2429](https://github.com/LayerC0de/career-ops-fork/issues/2429)) ([f589ce8](https://github.com/LayerC0de/career-ops-fork/commit/f589ce8306c4b3fcaee15619daca337ede7ce60e))
* **tracker:** rank Hired in dedup, canonicalize its aliases, stop bare tracker-number merges across roles ([#2377](https://github.com/LayerC0de/career-ops-fork/issues/2377)) ([83cde52](https://github.com/LayerC0de/career-ops-fork/commit/83cde5259131ee075e485a0418dbe8f8912a9539))
* **tracker:** set SQLite busy_timeout to avoid SQLITE_BUSY under concurrent access ([#2206](https://github.com/LayerC0de/career-ops-fork/issues/2206)) ([696a3a8](https://github.com/LayerC0de/career-ops-fork/commit/696a3a85108039527d746b326c752d816b49a4a7)), closes [#1957](https://github.com/LayerC0de/career-ops-fork/issues/1957)
* **tracker:** sync the PDF column from data/pdf-index.tsv ([#1969](https://github.com/LayerC0de/career-ops-fork/issues/1969)) ([85a894c](https://github.com/LayerC0de/career-ops-fork/commit/85a894c2555090c480067e0c819b53234f5ced3f)), closes [#1429](https://github.com/LayerC0de/career-ops-fork/issues/1429)
* **tracker:** treat Windows rename contention as contention, not death ([#2777](https://github.com/LayerC0de/career-ops-fork/issues/2777)) ([474ffc4](https://github.com/LayerC0de/career-ops-fork/commit/474ffc4f4c5f05929863a9d9f8528d32c0375c1a))
* **trust-validator:** a company with an accent in its name is flagged for being on its own domain ([5adc39f](https://github.com/LayerC0de/career-ops-fork/commit/5adc39fad7dfcb391642e74b7909942b10b462fe))
* **update-system:** apply .gitattributes before the files it governs ([b630da2](https://github.com/LayerC0de/career-ops-fork/commit/b630da27e682d326f6ec809c71e0928a8f469680))
* **update:** commit the index so file-mode changes are not dropped ([#2629](https://github.com/LayerC0de/career-ops-fork/issues/2629)) ([4b1d66b](https://github.com/LayerC0de/career-ops-fork/commit/4b1d66b22249506442906e673405bcfed7c58a57))
* **update:** ignore CRLF/LF-only differences when detecting local system edits ([#2820](https://github.com/LayerC0de/career-ops-fork/issues/2820)) ([9c06337](https://github.com/LayerC0de/career-ops-fork/commit/9c0633733c74453da0062a66e4dca3b76ba96741)), closes [#2817](https://github.com/LayerC0de/career-ops-fork/issues/2817)
* **update:** reconcile .gitignore on apply so new ignore rules reach existing installs ([#2857](https://github.com/LayerC0de/career-ops-fork/issues/2857)) ([2728cd0](https://github.com/LayerC0de/career-ops-fork/commit/2728cd0d40f0f640856e898aadc6999d05a8d2ba))
* **velocity:** count a web-written transition as an observation ([#2898](https://github.com/LayerC0de/career-ops-fork/issues/2898)) ([2e36380](https://github.com/LayerC0de/career-ops-fork/commit/2e363807429322c6f660b011d4b56b3222e3c3cb))
* **verify-cv-facts:** fold allow_metrics through the same noun synonyms ([#2720](https://github.com/LayerC0de/career-ops-fork/issues/2720)) ([5352f38](https://github.com/LayerC0de/career-ops-fork/commit/5352f380c550a0551165cb9f9c7194f0fd15dfdb))
* **verify-cv-facts:** stop the modifier count from deciding whether a claim exists ([#2279](https://github.com/LayerC0de/career-ops-fork/issues/2279)) ([11493bf](https://github.com/LayerC0de/career-ops-fork/commit/11493bfabe2ee9df2e85162bde0857ec18bf2ab4))
* **verify-cv-facts:** treat a period as a thousands separator too ([#2722](https://github.com/LayerC0de/career-ops-fork/issues/2722)) ([dceaddb](https://github.com/LayerC0de/career-ops-fork/commit/dceaddb3739173ca9f526851c16cdfa6cd717db1))
* **verify-pipeline:** orphan check masks and invents orphans ([#1425](https://github.com/LayerC0de/career-ops-fork/issues/1425)) ([b4309a0](https://github.com/LayerC0de/career-ops-fork/commit/b4309a00b0c4dd504689e9a6fe08788be82441de))
* **verify-pipeline:** Unicode-aware keys for company/role/Via grouping ([00a839f](https://github.com/LayerC0de/career-ops-fork/commit/00a839fe8611607ba8c21f871e11a5132a8066c6))
* **verify-portals:** --add probes slugs that cannot exist for an accented company name ([8bd65eb](https://github.com/LayerC0de/career-ops-fork/commit/8bd65ebeb9750ef20d503cfd8e281ecf90f5353c))
* **voice-dna:** make voice-dna.md private via the template pattern ([#2952](https://github.com/LayerC0de/career-ops-fork/issues/2952)) ([10a9c55](https://github.com/LayerC0de/career-ops-fork/commit/10a9c55147fb1a3ae6a7741f41fad59b68c79722))
...
* **weekly-digest:** --from=… was silently ignored, digesting the wrong week ([#2402](https://github.com/LayerC0de/career-ops-fork/issues/2402)) ([43af8c6](https://github.com/LayerC0de/career-ops-fork/commit/43af8c64b29d5110b679f0d5accfb7532baee508))
* **workable:** use the public widget API so large accounts are scanned ([5ab8425](https://github.com/LayerC0de/career-ops-fork/commit/5ab8425ce824a885af1724522319af46ad52c265))
* **workday:** key the cap-hit warning on entry provenance, not on --since ([#2763](https://github.com/LayerC0de/career-ops-fork/issues/2763)) ([7f067bc](https://github.com/LayerC0de/career-ops-fork/commit/7f067bce916a964411e27948b06227c4ca39bfd2))


### Performance Improvements

* **analytics:** drop redundant existsSync probes before report reads ([#2655](https://github.com/LayerC0de/career-ops-fork/issues/2655)) ([f06cbf8](https://github.com/LayerC0de/career-ops-fork/commit/f06cbf81bba797bc1cd758bca3d71866c80d9b9e))
* **detect-reposts:** bucket titles instead of comparing every pair ([#2389](https://github.com/LayerC0de/career-ops-fork/issues/2389)) ([a42a0bf](https://github.com/LayerC0de/career-ops-fork/commit/a42a0bf43b2b14235187c315898257252e0f5b03))
* **fingerprint:** popcount table + hoisted loop state in findCrossListings ([#2388](https://github.com/LayerC0de/career-ops-fork/issues/2388)) ([f2ffc7a](https://github.com/LayerC0de/career-ops-fork/commit/f2ffc7a065862f6e508b59e12cf1f1dad593cb68))
* **scan:** cache DNS lookups in-process to stop resolver floods ([#2155](https://github.com/LayerC0de/career-ops-fork/issues/2155)) ([bd7d1a8](https://github.com/LayerC0de/career-ops-fork/commit/bd7d1a80dc437f80e112f41a427c244d5edf8a90)), closes [#2154](https://github.com/LayerC0de/career-ops-fork/issues/2154)
* **scan:** read each dedup source once per scan run ([d68c4c9](https://github.com/LayerC0de/career-ops-fork/commit/d68c4c963592787df3b7a34d4e5f9bb48010415b))
* **tests:** fix the dead SSRF DNS stub and cut three fixed costs from test-all ([#2390](https://github.com/LayerC0de/career-ops-fork/issues/2390)) ([2f21fe7](https://github.com/LayerC0de/career-ops-fork/commit/2f21fe7722bb78b9ff322b7d208fc8ebfef56e08))
